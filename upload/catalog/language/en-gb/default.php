...
// Text
// The home breadcrumb is rendered as an icon. The visually hidden text gives the
// link an accessible name, which an icon alone cannot provide.
$_['text_home']             = '<i class="fas fa-home" aria-hidden="true"></i><span class="pb-visually-hidden">Home</span>';
$_['text_yes']              = 'Yes';
$_['text_no']               = 'No';
$_['text_none']             = ' --- None --- ';
