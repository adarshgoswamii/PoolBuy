...
class Home extends \Opencart\System\Engine\Controller {
	...
	public function index(): void {
		...
		// PoolBuy landing page. Rendered only while the extension is enabled, so
		// disabling PoolBuy restores the stock OpenCart home page without needing
		// this file to be reverted.
		$data['poolbuy_landing'] = '';

		if ($this->config->get('module_poolbuy_status')) {
			$data['poolbuy_landing'] = $this->load->controller('extension/poolbuy/poolbuy/landing');
		}
