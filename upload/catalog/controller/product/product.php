...
class Product extends \Opencart\System\Engine\Controller {
	...
	public function index(): ?\Opencart\System\Engine\Action {
		...
		if ($product_info) {
			...
			// PoolBuy pool status widget. Returns an empty string when the extension
			// is disabled or this product has no visible pool, so the stock product
			// page is unaffected in either case.
			$data['poolbuy_widget'] = '';

			if ($this->config->get('module_poolbuy_status')) {
				$data['poolbuy_widget'] = $this->load->controller('extension/poolbuy/poolbuy/widget', $product_id);
			}
